  ...
  return (
    <div className="mt-10">
      <div className="bg-black">
        <div className="flex flex-col font-raleway px-5 md:px-0 max-w-[1100px] w-full mx-auto py-20 text-center justify-items-center">
      ...
      <div className="max-w-[1100px] w-full mx-auto px-5 mb-20 md:px-0 font-raleway">
        <p className="py-5 text-center">
          ...
          just a slogan—it&apos;s our very essence. At Primestix, we reset the
          ...
          living. Our commitment remains steadfast: Primestix embodies only what
          ...
          unmatched craftsmanship and technological brilliance. With a focus on
          ...
          pioneering the future of However, our efforts don&apos;t end there.
          ...
          enlarging the possibilities of timeless sophistication. Join us on a
          ...
          and the disruptors of the ordinary. Welcome to Primestix, where

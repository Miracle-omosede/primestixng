        ...
        <div className="max-w-[1100px] mx-auto w-full md:px-0 px-10">
          ...
          <div className="banner-container" onClick={() => setShowModal(true)}>
            <div
              ...
              style={{
                backgroundImage: `url(${projectData?.bannerImage?.asset?.url})`,
          ...
          {/* ---banner title--- */}
          <h1 className="text-5xl font-bold py-5">{projectData?.name}</h1>
          <p className="text-xl font-[500]">{projectData?.description}</p>

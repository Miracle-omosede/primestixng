      ...
      >
        <SwiperSlide>
          ...
          <div className="absolute text-white top-0 z-10 flex flex-col md:grid grid-cols-12 justify-center items-start md:items-center w-full h-full left-[10%]">
            <motion.div
              className="flex md:gap-5 gap-2 flex-col md:col-span-6 col-span-12 md:items-start items-start font-raleway "
            ...
            >
              <motion.h1
                ...
                className="uppercase font-bold text-5xl flex items-start justify-start w-full text-left"
              >
                Trusted Partners
              </motion.h1>
              <motion.p
            ...
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: false, amount: 0.25 }}
              className="font-raleway  md:col-span-6 hidden md:flex"
            >
              <motion.p
                variants={textVariant(1.2)}
